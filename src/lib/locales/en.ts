...
export const en = {
  ...
  "categories.subtitle": "{count} categories · {items} items",
  "categories.items": "Items in this category",
  "categories.moveTo": "Move to",
  "categories.empty": "Nothing in here yet.",
  "categories.addBlurb": "Create a section, then assign items to it below.",
  ...
  "plan.title": "Plans",
  "plan.blurb": "Your plan sets how many branches the shop can run.",
  ...
  "plan.free": "Free",
  "plan.perMonth": "/ month",
  "plan.branchesOne": "1 branch",
  "plan.branchesMany": "Up to {count} branches",
  "plan.branchesUnlimited": "Unlimited branches",
  "plan.choose": "Choose",
  "plan.currentBadge": "Current",
  "plan.upgrade": "Upgrade",
  "plan.locked": "Branch limit reached",
  "plan.lockedBlurb":
    "{plan} includes {limit}. Upgrade to open another branch.",
  "plan.usage": "{used} of {limit} branches used",
  "plan.usageUnlimited": "{used} branches · unlimited",
  "plan.noCharge": "No card is charged — this picks a plan for now.",
  "plan.tilePlan": "Plan",
  ...
  "menu.categoryNamePlaceholder": "Smoothies",
  "menu.deleteCategory": "Delete {name}",
  "menu.categoryInUse": "{count} items",
  "menu.categoryEmptyCount": "No items",
  "menu.categoryBlocked": "{name} still has {count} items. Move them first.",
  "menu.categoriesEmpty": "No categories yet.",
  "menu.selectAll": "All",
